<head>
  ...
  <link rel="stylesheet" type="text/css" href="../plugins/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css">
  ...
  <link rel="stylesheet" type="text/css" href="../plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css">
