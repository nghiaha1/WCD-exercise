package com.wcdexercise.wcdexercise.entity;
...
//        this.ID = Integer.parseInt("");
    ...
    public Customer(String name, String phone, String img) {
        this.name = name;
        this.phone = phone;
        this.img = img;
        this.createAt = LocalDateTime.now();
    ...
    public String getJoinedAt() {
        if(this.createAt != null){
            return DateTimeHelper.convertLocalDateTimeToString(this.createAt);
        }
        return "";
    }
}
